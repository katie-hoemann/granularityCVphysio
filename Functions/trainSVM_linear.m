function [trainedClassifier, validationAccuracy] = trainSVM_linear(trainingData)
...
% Auto-generated by MATLAB on 28-Dec-2020 11:47:21
...
cv = cvpartition(response,'KFold',5,'Stratify',true); 
...
partitionedModel = crossval(trainedClassifier.ClassificationSVM,'CVPartition',cv);
